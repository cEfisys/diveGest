...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { horse_power: @boat.horse_power, mmsi: @boat.mmsi, name: @boat.name, seats: @boat.seats }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { horse_power: @boat.horse_power, mmsi: @boat.mmsi, name: @boat.name, seats: @boat.seats }
    assert_redirected_to boat_path(assigns(:boat))
  end
